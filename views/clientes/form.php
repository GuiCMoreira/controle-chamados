    ...
    <div class="row">
        <div class="col-md-6 offset-md-3">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="index.php?route=clientes/salvar<?php echo isset($cliente) ? '&id=' . $cliente->id : ''; ?>" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nome" name="nome" 
                                   value="<?php echo isset($cliente) ? htmlspecialchars($cliente->nome) : ''; ?>" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="email_portal" name="email_portal" 
                                   value="<?php echo isset($cliente) ? htmlspecialchars($cliente->email_portal) : ''; ?>">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control" id="senha_portal" name="senha_portal" 
                                   value="<?php echo isset($cliente) ? htmlspecialchars($cliente->senha_portal) : ''; ?>">
                        </div>
